...
/**
 * Manage communication with a Kewang peripheral over a Scrath Link client socket.
 */
class Kewang {

    /**
     * Construct a Kewang communication object.
...
/**
 * Scratch 3.0 blocks to interact with a Kewang peripheral.
 */
class Scratch3KewangBlocks {
    ...
    /**
     * Construct a set of Kewang blocks.
     * @param {Runtime} runtime - the Scratch 3.0 runtime.
     */
    constructor (runtime) {
        /**
        ...
        // Create a new Kewang peripheral instance
        this._peripheral = new Kewang(this.runtime, Scratch3KewangBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Scratch3KewangBlocks.EXTENSION_ID,
            name: Scratch3KewangBlocks.EXTENSION_NAME,
    ...
    _isTilted (direction) {
        ...
        case MicroBitTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= Scratch3KewangBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= Scratch3KewangBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Scratch3KewangBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Scratch3KewangBlocks;
